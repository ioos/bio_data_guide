...
\midrule
\endhead
\href{https://cran.r-project.org/web/packages/robis/index.html}{robis} & \\
\href{https://iobis.github.io/obistools/}{iobis/obistools} & \\
\href{https://cran.r-project.org/web/packages/worrms/index.html}{worrms} & \\
\href{https://cran.r-project.org/web/packages/tidyverse/index.html}{tidyverse} & \\
\href{https://cran.r-project.org/web/packages/lubridate/index.html}{lubridate} & \\
...
\href{https://cran.r-project.org/web/packages/finch/index.html}{finch} & \\
\href{https://cran.r-project.org/web/packages/taxize/index.html}{taxize} & \\
\href{https://www.rdocumentation.org/packages/Hmisc/versions/4.6-0}{Hmisc} & particularly \href{https://www.rdocumentation.org/packages/Hmisc/versions/4.6-0/topics/describe}{describe()} \\
\href{https://cran.r-project.org/web/packages/uuid/index.html}{uuid} & \\
\href{https://docs.ropensci.org/EML/}{ropensci/EML} & \\
\href{https://ediorg.github.io/EMLassemblyline/}{EDIorg/EMLasseblyline} & \\
\href{https://bdverse.org/}{bdveRse} & \\
\bottomrule
\end{longtable}
...
\href{https://github.com/iobis/pyworms}{pyworms} & \\
\href{https://docs.python.org/3/library/uuid.html}{uuid} & \\
\href{https://python-dwca-reader.readthedocs.io/en/latest/index.html}{python-dwca-reader} & \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\href{https://dwcaassistant.com/}{Google Sheet DarwinCore Archive Assistant add-on} & \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\href{https://tools.gbif.org/dwca-validator/}{Darwin Core Archive Validator} & \\
\href{https://www.gbif.org/tools/data-validator}{GBIF DATA VALIDATOR} & \\
\href{https://www.lifewatch.be/data-services/}{LifeWatch Belgium} & \\
\bottomrule
\end{longtable}
