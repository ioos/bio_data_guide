...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# The following command will remove all objects** for a fresh start. Make}
\CommentTok{\#   sure any objects you want to keep are saved before running!}
\FunctionTok{rm}\NormalTok{(}\AttributeTok{list =} \FunctionTok{ls}\NormalTok{())}

\CommentTok{\# Check working directory; set if necessary so document will compile}
\CommentTok{\#   properly}
\FunctionTok{getwd}\NormalTok{()}

\CommentTok{\# Install packages; uncomment and run if packages not already installed}
\CommentTok{\# install.packages(c("tidyverse", "uuid"))}

\CommentTok{\# Load packages}
\FunctionTok{lapply}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"tidyverse"}\NormalTok{, }\StringTok{"lubridate"}\NormalTok{, }\StringTok{"magrittr"}\NormalTok{, }\StringTok{"worrms"}\NormalTok{),}
\NormalTok{       library, }\AttributeTok{character.only =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{seagrassDensity }\OtherTok{\textless{}{-}}
  \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/ioos/bio\_data\_guide/main/datasets/hakai\_seagrass\_data/raw\_data/seagrass\_density\_survey.csv"}\NormalTok{,}
...
\NormalTok{seagrassHabitat }\OtherTok{\textless{}{-}}
  \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/ioos/bio\_data\_guide/main/datasets/hakai\_seagrass\_data/raw\_data/seagrass\_habitat\_survey.csv"}\NormalTok{,}
...
\NormalTok{coordinates }\OtherTok{\textless{}{-}}
  \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/ioos/bio\_data\_guide/main/datasets/hakai\_seagrass\_data/raw\_data/seagrassCoordinates.csv"}\NormalTok{,}
...
\FunctionTok{write.csv}\NormalTok{(seagrassEvent, }\StringTok{"../datasets/hakai\_seagrass\_data/processed\_data/hakaiSeagrassDwcEvent.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{write.csv}\NormalTok{(seagrassOccurrence, }\StringTok{"../datasets/hakai\_seagrass\_data/processed\_data/hakaiSeagrassDwcOccurrence.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{write.csv}\NormalTok{(seagrassMof, }\StringTok{"../datasets/hakai\_seagrass\_data/processed\_data/hakaiSeagrassDwcEmof.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
