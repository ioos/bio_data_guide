...
url_nc <- paste(url_base,url_package,url_file)
...
```{r}
file_nc <- "datasets/atn_satellite_telemetry/data/src/atn_45866_great-white-shark_trajectory_20090923-20091123.nc"
atn <- nc_open(file_nc)
atn
```
